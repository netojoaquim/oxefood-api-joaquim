    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/api/cliente").permitAll()//Cadastro de cliente
                .requestMatchers(HttpMethod.POST, "/api/auth").permitAll()//Login
                .requestMatchers(HttpMethod.POST, "/api/funcionario").permitAll()//Cadastro de funcionário
